  ...
  */
  ...
  --------------------------------------------------------------*/
    function mainNav() {
        ...
        $(".menu-item-has-children").append('<span class="cs_munu_dropdown_toggle"><span></span></span>');
  ...
  --------------------------------------------------------------*/
    function accordian() {
        ...
        $(".cs_accordian_head").on("click", function () {
            ...
            /* Accordian Active Class */ $(this).parents(".cs_accordian").addClass("active");
            $(this).parent(".cs_accordian").siblings().removeClass("active");
            $(this).parents(".col-lg-6").siblings().find(".cs_accordian").removeClass("active");
        });
    }
  ...
  --------------------------------------------------------------*/
    ...
    function colorPicker() {
        $(".cs_color_option").on("click", function () {
            ...
            document.body.style.setProperty("--accent-color", selectedColor, "important");
